...
def main():
    ...
    file_name = ['../P53_Database/P53_data_csv/S_PREVALENCE.csv',
                ...
                '../P53_Database/P53_data_csv/M_REFERENCE.csv',
                '../P53_Database/P53_data_csv/Count_MUTID_GERM.csv',
                ...
                '../P53_Database/P53_data_csv/.DS_Store',
                '../P53_Database/P53_data_csv/SomaticView.csv',
                '../P53_Database/P53_data_csv/RSP_chainB.csv',
                ...
                '../P53_Database/P53_data_csv/S_Response_dic.csv',
                ...
                '../P53_Database/P53_data_csv/S_Treatment_dic.csv',
                '../P53_Database/P53_data_csv/ISOFORMS_STATUS.csv',
                '../P53_Database/P53_data_csv/sysdiagrams.csv',
                '../P53_Database/P53_data_csv/TASKS.csv',
                '../P53_Database/P53_data_csv/Morphogroup_dic.csv',
                '../P53_Database/P53_data_csv/S_CLINICAL_DATA.csv',
                ...
                '../P53_Database/P53_data_csv/G_SCREENING.csv',
                ...
                '../P53_Database/P53_data_csv/G_Other_MUTATION.csv',
                '../P53_Database/P53_data_csv/MUTATION.csv',
                '../P53_Database/P53_data_csv/Exposure_dic.csv',
                '../P53_Database/P53_data_csv/EXCLUDED_REFS.csv',
                '../P53_Database/P53_data_csv/Count_MUTID_SOM.csv',
                '../P53_Database/P53_data_csv/G_Classification_dic.csv',
                '../P53_Database/P53_data_csv/DATA_REQUEST.csv',
                ...
                '../P53_Database/P53_data_csv/dtproperties.csv',
                '../P53_Database/P53_data_csv/POLYMORPHISM.csv',
                '../P53_Database/P53_data_csv/F_Transactivation_dic.csv',
