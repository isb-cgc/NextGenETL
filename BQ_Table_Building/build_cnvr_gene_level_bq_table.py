...
def merge_bq_sql(cnv_table, aliquot_table, case_table): # todo update to new fields
    """
...
def merge_bq_sql_masked(cnv_table, aliquot_table, case_table): #what is the difference betweent this function and the one above?
    """
    SQL Code For Final Table Generation
