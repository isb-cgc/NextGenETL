...
cd ..
python3.11 ./BQ_Table_Building/build_gdc_api_clinical_bulk_table.py ~/config/ClinicalBQBuild.yaml
python3.11 ./BQ_Table_Building/build_gdc_api_clinical_program_tables.py ~/config/ClinicalProgramBQBuild.yaml
deactivate
