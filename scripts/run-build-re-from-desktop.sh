...
gsutil cp gs://${CONFIG_BUCKET}/${CURRENT_CONFIG_PATH}/BuildRegulomeExplorer.yaml .
popd > /dev/null
...
popd > /dev/null
cd ..
${PY_PATH}/python3 ./BQ_Table_Building/build_regulome_explorer_import_v2.py ${CONFIG_DIR}/BuildRegulomeExplorer.yaml
deactivate
